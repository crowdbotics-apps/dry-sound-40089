"""
Django settings for dry_sound_40089 project.
...
ROOT_URLCONF = 'dry_sound_40089.urls'
...
WSGI_APPLICATION = 'dry_sound_40089.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "dry_sound_40089 API",
    "DESCRIPTION": "API documentation for dry_sound_40089 App",
    "VERSION": "v1",
}
